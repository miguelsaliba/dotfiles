...
require('gitsigns').setup({
  on_attach = function(bufnr)
    ...
    map('n', '<leader>hD', function() gitsigns.diffthis('~') end, { desc = 'Diff this against index' })

    map('n', '<leader>hQ', function() gitsigns.setqflist('all') end, { desc = 'Set quickfix list with all hunks' })
    map('n', '<leader>hq', gitsigns.setqflist, { desc = 'Set quickfix list with hunks from current file' })
